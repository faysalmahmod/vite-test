  ...
  return (
    <div className="md:grid grid-cols-4 p-5 md:p-0">
      <div data-aos="fade-right" >
        <h1 className="text-3xl font-light mb-3">Exec Digital</h1>
        <p className="mb-1">A108 Adam Street</p>
        <p className="mb-5">New York, NY 535022</p>

        <div>
          <p className="font-medium">
            Phone: <span className="font-normal ml-1">+1 (647) 745 5519</span>
          </p>
          <p className="font-medium">
      ...
      <div data-aos="fade-right" data-aos-delay="300" className="mt-10 md:mt-0">
        ...
        <ul>
          ...
          <li className="mb-2 arrow">
            <a href="/Marketing-Website/#services" className="text-zinc-700">
              Service
            </a>
          </li>
          <li className="mb-2 arrow">
            <a href="/Marketing-Website/#portfolio" className="text-zinc-700">
              Portfolio
            </a>
          </li>
        </ul>
      ...
      <div data-aos="fade-right" data-aos-delay="700" className="mt-10 md:mt-0">
        ...
        <p className="text-sm">
         Follow us using on social media for latest deals and updates.
        </p>
