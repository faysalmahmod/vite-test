...
import img from "../img/hero91.jpg";
...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center lg:gap-10 secondary-font relative">
      ...
      >
        <h1 className="text-[#7A6960] md:text-4xl text-2xl font-semibold">
        Elevate your brand, amplify your success
        </h1>
        <p className="text-xl mt-5 text-gray-600 primary-font">
        We help Transforming visions into victories, enhancing operational efficiency, driving growth, and elevating brand visibility. 
